const Page = () => {
  return (
    <div className="pages !mt-[65px] bg-white !my-6 !mx-auto shadow rounded-2xl px-3 md:max-w-lg lg:max-w-4xl">
      <h2>
        <strong>Terms and Conditions</strong>
      </h2>

      <p>Welcome to bigroms.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of bigroms.com&apos;s Website, located at https://bigroms.com/.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use bigroms.com if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing bigroms.com, you agreed to
        use cookies in agreement with the bigroms.com&apos;s Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, bigroms.com and/or its licensors own the
        intellectual property rights for all material on bigroms.com. All
        intellectual property rights are reserved. You may access this from
        bigroms.com for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from bigroms.com</li>
        <li>Sell, rent or sub-license material from bigroms.com</li>
        <li>Reproduce, duplicate or copy material from bigroms.com</li>
        <li>Redistribute content from bigroms.com</li>
      </ul>

      <p>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        bigroms.com does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of bigroms.com,its agents and/or affiliates. Comments reflect
        the views and opinions of the person who post their views and opinions.
        To the extent permitted by applicable laws, bigroms.com shall not be
      ...
      <p>
        bigroms.com reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant bigroms.com a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of bigroms.com; and (d) the link
      ...
      <p>
        ...
        e-mail to bigroms.com. Please include your name, your organization name,
      ...
      <p>
        No use of bigroms.com&apos;s logo or other artwork will be allowed for
