const Page = () => {
  return (
    <div className="pages !mt-[65px] bg-white !my-6 !mx-auto shadow px-3 rounded-2xl md:max-w-lg lg:max-w-4xl">
      <h1>Privacy Policy for bigroms.com</h1>

      <p>
        At bigroms.com, accessible from https://bigroms.com/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        bigroms.com and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in bigroms.com. This policy is not applicable to
      ...
      <p>
        bigroms.com follows a standard procedure of using log files. These files
      ...
      <p>
        ...
        advertising partners of bigroms.com.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on bigroms.com, which are sent
      ...
      <p>
        Note that bigroms.com has no access to or control over these cookies
      ...
      <p>
        bigroms.com&apos;s Privacy Policy does not apply to other advertisers or
      ...
      <p>
        bigroms.com does not knowingly collect any Personal Identifiable
